...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'List of Packages ToPay', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
$pdf->Ln(23);
...
//CONSULTA
$result = mysql_query("SELECT * FROM courier WHERE  book_mode = 'ToPay'  AND officename='".$_SESSION["user_type"]."' AND book_date   BETWEEN '$desde' AND '$hasta' ");
...
$pdf->Output('reports_pdf/List-of-Packages-ToPaid.pdf','D');
?>