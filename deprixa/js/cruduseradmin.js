...
var treload = $('#tabla-usuarios').DataTable({
	...
	ajax: { // configuración ajax
            "url": "settings/addusersadmin/listar.php",
            "type": "GET",
			"dataSrc": ""
    },
...
var datos = $('#formularioNuevo').serialize();	// recuperamos todos los campos del formulario
            ...
            type: "POST",
            url: "settings/addusersadmin/agregar.php",
            data: datos,
			dataType:"json"
        	}).done(function(data){
...
var datos = $('#formularioEditar').serialize(); // recuperamos todos los campos del formulario editar usuario
			$.ajax ({ // configuraci{on de ajax
            type: "POST",
            url: "settings/addusersadmin/actualizar.php",
            data: datos,
			dataType:"json"
        	}).done(function(data){
				if(data.msg=='ok'){
...
function(){ // esta función se ejecuta cuando confirmamos  por si
	...
	$.ajax ({ // configuración de ajax
				type: "POST",
				url: "settings/addusersadmin/eliminar.php",
				data: { "cid" : cid },
				dataType:"json"
				}).done(function(data){
					if(data.msg=='ok'){
...
function(){
	...
	$.ajax ({ // configuración de ajax
				type: "POST",
				url: "settings/addusersadmin/estado.php",
				data: { "cid" : cid },
				dataType:"json"
				}).done(function(data){
					if(data.msg=='ok'){
...
$(document).on("click", '.editar', function (event) {
			...
			$.ajax ({ // configuración de ajax
            type: "POST",
            url: "settings/addusersadmin/editar.php",
            data: { "cid":cid },
			dataType: 'json'
        	}).done(function(data){
